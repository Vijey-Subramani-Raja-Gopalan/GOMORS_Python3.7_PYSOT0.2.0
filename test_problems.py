...
class ZDT3(OptimizationProblem):
    #  Details: http://www.cs.unm.edu/~neal.holts/dga/benchmarkFunction/ackley.html
    #  Global optimum: f(0,0,...,0)=0
    def __init__(self, dim=8, nobj=2):
        self.lb =  np.zeros(dim)
...
class ZDT6(OptimizationProblem):
    #  Details: http://www.cs.unm.edu/~neal.holts/dga/benchmarkFunction/ackley.html
    #  Global optimum: f(0,0,...,0)=0
    def __init__(self, dim=8, nobj=2):
        self.lb =  np.zeros(dim)
...
class LZF2(OptimizationProblem):
    #  Details: http://www.cs.unm.edu/~neal.holts/dga/benchmarkFunction/ackley.html
    #  Global optimum: f(0,0,...,0)=0
    def __init__(self, dim=8, nobj=2):
        self.lb =  np.zeros(dim)
...
class LZF3(OptimizationProblem):
    #  Details: http://www.cs.unm.edu/~neal.holts/dga/benchmarkFunction/ackley.html
    #  Global optimum: f(0,0,...,0)=0
    def __init__(self, dim=8, nobj=2):
        self.lb =  np.zeros(dim)
...
class LZF5(OptimizationProblem):
    #  Details: http://www.cs.unm.edu/~neal.holts/dga/benchmarkFunction/ackley.html
    #  Global optimum: f(0,0,...,0)=0
    def __init__(self, dim=8, nobj=2):
        self.lb =  np.zeros(dim)
...
class LZF6(OptimizationProblem):
    #  Details: http://www.cs.unm.edu/~neal.holts/dga/benchmarkFunction/ackley.html
    #  Global optimum: f(0,0,...,0)=0
    def __init__(self, dim=8, nobj=2):
        self.lb =  np.zeros(dim)
...
class Schwefel_with_Sphere_Problem(OptimizationProblem):

    def __init__(self, nobj):
        dim = 2                             # amount of decision variables
        self.lb = np.array([-500, -500])    # lower bound for x1, x2, ...
        self.ub = np.array([500, 500])      # upper bound for x1, x2, ...
        self.dim = dim
        self.nobj = nobj
    ...
    def objfunction(self, solution):
        ...
        """solution = Design variables values for evaluation"""
        self.__check_input__(solution)
